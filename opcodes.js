...
export const OpCodes_SetDriverLayerKeyValues  =
{
    KeySet = 1,
    KeySetFn = 2,
    /// <summary>
...
export const OpCodes_DriverLayerUpdateRealtimeLighting =
{
    Update = 1,
    UpdateComplete = 2
}

export const OpCodes_DriverMacro =
{
    MouseState = 1,
    KeyboardState = 2,
...
/// </summary>
export const KeyboardLayerDataType = 
{
    Invalid,
